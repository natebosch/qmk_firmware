...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------------.                      ,-----------------------------------------------------------.
       XXXXXXX,  XXXXXXX,  KC_VOLU,  KC_VOLD,  KC_MUTE,  KC_BRIU,                         XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
  //|---------+---------+---------+---------+---------+---------|                      |---------+---------+---------+---------+---------+---------|
  ...
  //|---------+---------+---------+---------+---------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  RGB_HUI,  RGB_SAD,  RGB_VAI,  RGB_SPI,  QK_BOOT,                         QK_BOOT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
  //|---------+---------+---------+---------+---------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  RGB_HUD,  RGB_SAI,  RGB_VAD,  RGB_SPD,  RGB_MOD,                         XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
                                             TO(l_qwt),  _______,  _______,     _______,  _______,TO(l_qwt)
                                          //`-----------------------------'  `-----------------------------'
  ),
...
const uint8_t PROGMEM rgb_layers[][MATRIX_ROWS][MATRIX_COLS * 3] = {
  // qwerty layout
  [l_qwt] = {},
  ...
  [l_ls1] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x80, 0xFF,  0x7F, 0x00, 0xFF},
    {0x00, 0x00, 0x00,  0x00, 0x80, 0xFF,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    ...
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x80, 0xFF,  0x00, 0x80, 0xFF,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0xFF, 0x80,  0xFF, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  },
  ...
  [l_arw] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0xFF, 0x80,
      0x00, 0xFF, 0x80,  0xCC, 0x66, 0x00,  0x00, 0xFF, 0x80},
    {0x00, 0x00, 0x00,  0xFF, 0x00, 0x00,  0xCC, 0x66, 0x00,
      0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x7F, 0x00, 0xFF},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    ...
    {0x00, 0xFF, 0x00,  0x00, 0xFF, 0x00,  0x00, 0xFF, 0x00,
      0x00, 0xFF, 0x00,  0x66, 0x66, 0xFF,  0x00, 0x00, 0x00},
    {0x99, 0xCC, 0xFF,  0x99, 0xCC, 0xFF,  0x99, 0xCC, 0xFF,
      0x99, 0xCC, 0xFF,  0x00, 0xFF, 0x80,  0x00, 0x00, 0x00},
    {0x00, 0xFF, 0x80,  0x00, 0xFF, 0x80,  0xFF, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  },
  ...
  [l_sym] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0xFF, 0x00, 0x00,
      0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
    ...
    {0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  ...
  [l_del] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,
      0xFF, 0x00, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    ...
    {0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x4C, 0x00, 0x99,  0x4C, 0x00, 0x99,  0x4C, 0x00, 0x99,
      0x4C, 0x00, 0x99,  0x4C, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0xFF, 0x44,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x4C, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0xFF, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  },
  ...
  [l_fig] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0xCC, 0x66, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,
      0xCC, 0x66, 0x00,  0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0x00, 0x00, 0x00},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},

    {0x00, 0x66, 0xCC,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0x66, 0xCC,  0x00, 0x00, 0x00},
    {0x00, 0x66, 0xCC,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0x66, 0xCC,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x40,  0x4C, 0x00, 0x99,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0xFF, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  },
  ...
  [l_fun] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0xCC, 0x66, 0x00,  0xFF, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,
      0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,  0x00, 0x00, 0x00,},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0xCC, 0x66, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},

    {0x00, 0x00, 0x00,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,
  ...
  [l_rs1] = {
    ...
    {0x7F, 0x00, 0xFF,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x66, 0x66, 0xFF,  0x66, 0x66, 0xFF,
      0x00, 0x00, 0x00,  0x66, 0x66, 0xFF,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0xFF, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  ...
  // Media controls
  [l_med] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x4C, 0x99, 0x00,
      0x33, 0x66, 0x00, 0x19, 0x33, 0x00,  0x99, 0xCC, 0xFF},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0xCC,
      0x00, 0xFF, 0x00,  0x00, 0x00, 0xCC,  0x45, 0x66, 0x88},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x33, 0x33, 0xFF,
      0xFF, 0x00, 0x00,  0x33, 0x33, 0xFF,  0x00, 0x00, 0x00},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  ...
  [l_nav] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x4C, 0x00, 0x99,  0x4C, 0x00, 0x99,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x99, 0x4C,  0x99, 0x99, 0x00,
      0x99, 0x33, 0xFF,  0x99, 0x33, 0xFF,  0x00, 0x80, 0xFF},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x80, 0xFF,  0x00, 0x99, 0x00,  0x00, 0x4C, 0x99},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  ...
  // Board control layer
  [l_ctl] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x4C, 0x99,
      0x00, 0x7F, 0xFF,  0xFF, 0x00, 0xFF,  0xFF, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x66, 0xCC,  0xCC, 0x99, 0xFF,
      0x00, 0xFF, 0x80,  0x00, 0xFF, 0xFF,  0x66, 0x00, 0xCC},
    {0x00, 0x00, 0x00,  0x00, 0xCC, 0x66,  0x00, 0x66, 0xCC,
      0x00, 0x99, 0x4C,  0x00, 0x99, 0x99,  0x00, 0xFF, 0x7F},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},

    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x66, 0x00, 0xCC,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0xFF, 0x00, 0x00,
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
  ...
  for (uint8_t row = 0; row < MATRIX_ROWS; ++row) {
    for (uint8_t col = 0; col < MATRIX_COLS; ++col) {
      ...
      uint8_t red = rgb_layers[layer][row][col_offset];
      uint8_t blue = rgb_layers[layer][row][col_offset + 1];
      uint8_t green = rgb_layers[layer][row][col_offset + 2];
      if (red == 0 && blue == 0 && green == 0) continue;
      // divide by 256 unless heat map, then divide in half again
      uint8_t mode = rgb_matrix_get_mode();
      int shift = mode == RGB_MATRIX_TYPING_HEATMAP ? 9 : 8;
      rgb_matrix_set_color(index,
          (red * brightness) >> shift,
          (blue * brightness) >> shift,
          (green * brightness) >> shift);
    }
  }
  return false;
}
