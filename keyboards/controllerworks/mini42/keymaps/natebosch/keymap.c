...
const uint16_t PROGMEM df_esc_combo[] = {ALT_D, SFT_F, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [l_ls1] = LAYOUT_split_3x6_3(
       XXXXXXX,  XXXXXXX,  XXXXXXX,   C_SCLN,  C_QUOTE,TT(l_ctl),         XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
       XXXXXXX,TT(l_arw),TT(l_sym),TT(l_del),TT(l_fig),TT(l_fun),         XXXXXXX,  XXXXXXX,  XXXXXXX,   C_SCLN,  C_QUOTE,  XXXXXXX,
  ...
  [l_fun] = LAYOUT_split_3x6_3(
       ...
       XXXXXXX,  KC_LCTL,  KC_LGUI,  KC_LALT,  KC_LSFT,TT(l_fun),         XXXXXXX,    KC_F4,    KC_F5,    KC_F6,   KC_F11,  XXXXXXX,
  ...
  [l_rs1] = LAYOUT_split_3x6_3(
       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,       TT(l_ctl),   C_SCLN,  C_QUOTE,  XXXXXXX,  XXXXXXX,  XXXXXXX,
...
const uint8_t PROGMEM rgb_layers[][MATRIX_ROWS][MATRIX_COLS * 3] = {
  ...
  [l_ls1] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x80, 0xFF,  0x00, 0x80, 0xFF,  0x7F, 0x00, 0xFF},
    {0x00, 0x00, 0x00,  0x00, 0x80, 0xFF,  0x00, 0xFF, 0x44,
      0x00, 0xFF, 0x44,  0x00, 0xFF, 0x44,  0x00, 0x80, 0xFF},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x99, 0x33, 0xFF,  0x99, 0x33, 0xFF,  0x00, 0x00, 0x00},
  ...
  [l_fun] = {
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0xCC, 0x66, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00,  0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,
      0xCC, 0x66, 0x00,  0xCC, 0x66, 0x00,  0xFF, 0x00, 0x00,},
    {0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0xCC, 0x66, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
    {0xFF, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
  ...
  [l_rs1] = {
    ...
    {0x7F, 0x00, 0xFF,  0x00, 0x80, 0xFF,  0x00, 0x80, 0xFF,
      0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00},
